  ...
  <div class="container mt-5">
    ...
    <div class="card mb-3">
      <div class="card-body d-flex justify-content-between align-items-center">
        <p><strong>Felhasználónév:</strong> {{ isEditingField === 'username' ? '' : user.username }}</p>
        <div v-if="isEditingField === 'username'" class="d-flex align-items-center">
          <input
            type="text"
          ...
          />
          <button class="btn btn-success me-2" @click="saveField('username')">Mentés</button>
          <button class="btn btn-secondary" @click="cancelEdit">Mégse</button>
        </div>
        <button v-else class="btn btn-warning" @click="startEdit('username')">Módosítás</button>
      </div>
    </div>
        ...
        <div class="card mb-3">
      <div class="card-body d-flex justify-content-between align-items-center">
        <p><strong>Felhasználónév:</strong> {{ isEditingField === 'name' ? '' : user.name }}</p>
